...
It shows that the virus concentration is determined by two exponential terms and their parameters *k*^I, *k*<sub>V</sub>. Long time behavior of the equation will be dominated by the one with smaller parameter. 
